...
\begin{center}
	...
	\node[state](OPD)  {OPD};
	\node[state](OPR)  {OPR};
	\path[->] (S)   edge node [loop above]  {startLearning} (SLP)
				    edge node  [loop above]  {reverseAuto}	 (RAP)
				    edge node  [loop above]  {directAuto}	 (DAP);
			  (SLP) edge node [loop above]  {stop} (SLP)
			  		edge node [loop above]  {backward} (BLP)
					edge node [loop above]  {forward} (FLP)
					edge node [loop above]  {right} (RLP)
					edge node [loop above]  {left} (LLP)
					edge node [loop above]  {terminate} (I)
			  (RLP) edge node [loop above]  {stop} (SLP)
			  		edge node [loop above]  {backward} (BLP)
					edge node [loop above]  {forward} (FLP)
					edge node [loop above]  {right} (RLP)
					edge node [loop above]  {left} (LLP)
					edge node [loop above]  {terminate} (I)
			  (LLP) edge node [loop above]  {stop} (SLP)
			  		edge node [loop above]  {backward} (BLP)
					edge node [loop above]  {forward} (FLP)
					edge node [loop above]  {right} (RLP)
					edge node [loop above]  {left} (LLP)
					edge node [loop above]  {terminate} (I)
			  (FLP) edge node [loop above]  {stop} (SLP)
			  		edge node [loop above] {backward} (BLP)
					edge node [loop above] {forward} (FLP)
					edge node [loop above] {right} (RLP)
					edge node [loop above] {left} (LLP)
					edge node [loop above] {terminate} (I)
			  (BLP) edge node [loop above] {stop} (SLP)
			  		edge node [loop above] {backward} (BLP)
					edge node [loop above] {forward} (FLP)
					edge node [loop above] {right} (RLP)
					edge node [loop above] {left} (LLP)
					edge node [loop above] {terminate} (I)
			  (RAP) edge node [loop above] {end} (S)
			  		edge node [loop above] {stop} (S)
			  		edge node [loop above] {obstacleDetected} (OPR)
			  (DAP) edge node [loop above] {end} (S)
			  		edge node [loop above] {stop} (S)
			  		edge node [loop above] {obstacleDetected} (OPD)
			  (OPR) edge node [loop above] {stop} (S)
			  		edge node [loop above] {resume} 
			  (OPD) edge node [loop above] {stop} (S)
			  		edge node [loop above] {resume}
	\end{tikzpicture}
\end{center}
